...
export function SiteNav({ variant = "light", buyBar = false }: { variant?: "hero" | "light"; buyBar?: boolean }) {
  ...
  const bar = hero
    ? "mx-auto flex max-w-container items-center justify-between gap-4 rounded-full border border-white/10 bg-[#524d48]/80 px-3 py-2 pl-5 text-white shadow-soft backdrop-blur-md"
