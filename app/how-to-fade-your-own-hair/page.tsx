...
const steps: { title: string; text: string }[] = [
  ...
  { title: "Glide it flat around your head", text: "Hold the clipper flat against the side of your head and glide it horizontally around the sides and back — no flicking or wrist motion needed. The tapered 45° blade automatically blends short-to-long as you pass, so you don't have to 'guess' guard numbers." },
  { title: "Work around the whole head", text: "Keep making those level, horizontal passes around the sides and back. For the back of your head, use your phone camera or a second mirror — most people get it on the second pass." },
...
const faqs: { q: string; a: string }[] = [
  { q: "How do you fade your own hair at home?", a: "Brush your hair dry, cut the top to your chosen length, decide where the fade should start (low, mid or high), then glide an auto-fade clipper like the FadeClipper flat and horizontally around your head along that line. The tapered blade blends the gradient for you, so you just repeat those level passes around the sides and back until it looks smooth. Most beginners get a clean fade on their first or second try." },
  ...
  { q: "How much does it cost to fade your own hair vs going to a barber?", a: "A barber fade is typically $30–$50 and most people go every 2–3 weeks, which is roughly $600–$850 a year. The FadeClipper is a one-time purchase (currently $89.99 on launch sale), so it usually pays for itself within the first two haircuts." },
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        offers: { "@type": "Offer", price: "89.99", priceCurrency: "USD", availability: "https://schema.org/InStock", url: `${SITE_URL}/product` },
      },
    ],
  };
          ...
          <Section id="vs-barber" title="FadeClipper vs the barber: the real cost">
            ...
            <CompareTable
              ...
              rows={[
                ...
                ["First-year cost", "~$680", "$89.99 once"],
                ["Booking & travel", "Every time", "Never"],
                ["Touch-ups between cuts", "Pay again", "Free, anytime"],
              ]}
            />
            <p className="!mt-6">
              At a one-time <strong><Price usd={89.99} /></strong>, the FadeClipper typically pays for itself within{" "}
