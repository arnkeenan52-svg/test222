  ...
  return (
    ...
    >
      ...
      <p>
        ...
        give it a little time — then reach out at <a href="mailto:contact@fadeclipper.com">contact@fadeclipper.com</a>.
      </p>
      ...
      <h2>Questions</h2>
      <p>
        Email <a href="mailto:contact@fadeclipper.com">contact@fadeclipper.com</a> with your order number and we&apos;ll
        help.
      </p>
    </PageShell>
  );
